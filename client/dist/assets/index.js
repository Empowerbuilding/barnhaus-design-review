 ...
 */var nm;function ap(){if(nm)return Kn;nm=1;var u=Symbol.for("react.transitional.element"),f=Symbol.for("react.fragment");function s(r,d,h){var b=null;if(h!==void 0&&(b=""+h),d.key!==void 0&&(b=""+d.key),"key"in d){h={};for(var C in d)C!=="key"&&(h[C]=d[C])}else h=d;return d=h.ref,{$$typeof:u,type:r,key:b,ref:d!==void 0?d:null,props:h}}return Kn.Fragment=f,Kn.jsx=s,Kn.jsxs=s,Kn}var im;function np(){return im||(im=1,qr.exports=ap()),qr.exports}var g=np(),Xr={exports:{}},le={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sm;function op(){if(sm)return it;sm=1;var u=Pr();function f(x){var m="https://react.dev/errors/"+x;if(1<arguments.length){m+="?args[]="+encodeURIComponent(arguments[1]);for(var T=2;T<arguments.length;T++)m+="&args[]="+encodeURIComponent(arguments[T])}return"Minified React error #"+x+"; visit "+m+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function s(){}var r={d:{f:s,r:function(){throw Error(f(522))},D:s,C:s,L:s,m:s,X:s,S:s,M:s},p:0,findDOMNode:null},d=Symbol.for("react.portal");function h(x,m,T){var z=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:d,key:z==null?null:""+z,children:x,containerInfo:m,implementation:T}}var b=u.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function C(x,m){if(x==="font")return"";if(typeof m=="string")return m==="use-credentials"?m:""}return it.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=r,it.createPortal=function(x,m){var T=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!m||m.nodeType!==1&&m.nodeType!==9&&m.nodeType!==11)throw Error(f(299));return h(x,m,null,T)},it.flushSync=function(x){var m=b.T,T=r.p;try{if(b.T=null,r.p=2,x)return x()}finally{b.T=m,r.p=T,r.d.f()}},it.preconnect=function(x,m){typeof x=="string"&&(m?(m=m.crossOrigin,m=typeof m=="string"?m==="use-credentials"?m:"":void 0):m=null,r.d.C(x,m))},it.prefetchDNS=function(x){typeof x=="string"&&r.d.D(x)},it.preinit=function(x,m){if(typeof x=="string"&&m&&typeof m.as=="string"){var T=m.as,z=C(T,m.crossOrigin),H=typeof m.integrity=="string"?m.integrity:void 0,V=typeof m.fetchPriority=="string"?m.fetchPriority:void 0;T==="style"?r.d.S(x,typeof m.precedence=="string"?m.precedence:void 0,{crossOrigin:z,integrity:H,fetchPriority:V}):T==="script"&&r.d.X(x,{crossOrigin:z,integrity:H,fetchPriority:V,nonce:typeof m.nonce=="string"?m.nonce:void 0})}},it.preinitModule=function(x,m){if(typeof x=="string")if(typeof m=="object"&&m!==null){if(m.as==null||m.as==="script"){var T=C(m.as,m.crossOrigin);r.d.M(x,{crossOrigin:T,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0})}}else m==null&&r.d.M(x)},it.preload=function(x,m){if(typeof x=="string"&&typeof m=="object"&&m!==null&&typeof m.as=="string"){var T=m.as,z=C(T,m.crossOrigin);r.d.L(x,T,{crossOrigin:z,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0,type:typeof m.type=="string"?m.type:void 0,fetchPriority:typeof m.fetchPriority=="string"?m.fetchPriority:void 0,referrerPolicy:typeof m.referrerPolicy=="string"?m.referrerPolicy:void 0,imageSrcSet:typeof m.imageSrcSet=="string"?m.imageSrcSet:void 0,imageSizes:typeof m.imageSizes=="string"?m.imageSizes:void 0,media:typeof m.media=="string"?m.media:void 0})}},it.preloadModule=function(x,m){if(typeof x=="string")if(m){var T=C(m.as,m.crossOrigin);r.d.m(x,{as:typeof m.as=="string"&&m.as!=="script"?m.as:void 0,crossOrigin:T,integrity:typeof m.integrity=="string"?m.integrity:void 0})}else r.d.m(x)},it.requestFormReset=function(x){r.d.r(x)},it.unstable_batchedUpdates=function(x,m){return x(m)},it.useFormState=function(x,m,T){return b.H.useFormState(x,m,T)},it.useFormStatus=function(){return b.H.useHostTransitionStatus()},it.version="19.2.4",it}var fm;function sp(){if(fm)return Vr.exports;fm=1;function u(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(u)}catch(f){console.error(f)}}return u(),Vr.exports=op(),Vr.exports}/**
 * @license React
...
`;function Qm({messages:u,onSend:f,isComplete:s}){const[r,d]=S.useState(""),[h,b]=S.useState(!1),C=S.useRef(null);S.useEffect(()=>{var m;(m=C.current)==null||m.scrollIntoView({behavior:"smooth"})},[u]);const x=async()=>{if(!r.trim()||h)return;const m=r.trim();d(""),b(!0),await f(m),b(!1)};return g.jsxs("div",{className:"chat-window",children:[g.jsx("style",{children:kg}),g.jsxs("div",{className:"chat-header",children:[g.jsx("div",{className:"silas-avatar-small",children:"S"}),g.jsxs("div",{className:"chat-header-info",children:[g.jsx("span",{className:"chat-header-name",children:"Silas"}),g.jsx("span",{className:"chat-header-role",children:"Barnhaus Design Guide"})]}),g.jsx("div",{className:"chat-header-status"})]}),g.jsxs("div",{className:"chat-messages",children:[u.map((m,T)=>g.jsxs("div",{className:`chat-msg ${m.role}`,children:[m.role==="assistant"&&g.jsx("div",{className:"msg-avatar silas-bubble",children:"S"}),g.jsx("div",{className:"msg-bubble",children:m.content})]},T)),h&&g.jsxs("div",{className:"chat-msg assistant",children:[g.jsx("div",{className:"msg-avatar silas-bubble",children:"S"}),g.jsxs("div",{className:"msg-bubble typing",children:[g.jsx("span",{}),g.jsx("span",{}),g.jsx("span",{})]})]}),s&&g.jsxs("div",{className:"chat-msg assistant",children:[g.jsx("div",{className:"msg-avatar silas-bubble",children:"S"}),g.jsx("div",{className:"msg-bubble completion-note",children:"Your feedback has been sent to the Barnhaus team. We'll be in touch shortly with next steps. 🏡"})]}),g.jsx("div",{ref:C})]}),g.jsxs("div",{className:"chat-input-area",children:[g.jsx("input",{type:"text",value:r,onChange:m=>d(m.target.value),onKeyDown:m=>m.key==="Enter"&&x(),placeholder:s?"Review complete!":"Type your response...",disabled:h||s}),g.jsx("button",{onClick:x,disabled:!r.trim()||h||s,className:"send-btn",children:g.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[g.jsx("line",{x1:"22",y1:"2",x2:"11",y2:"13"}),g.jsx("polygon",{points:"22 2 15 22 11 13 2 9 22 2"})]})})]})]})}const Jg=`
  .inspiration-strip {
    padding: 0.75rem 1rem;
    background: #1e1e1e;
...
`;function Gm({images:u,onPick:f}){const[s,r]=S.useState(null);if(!u||u.length===0)return null;const d=T=>r(T),h=()=>r(null),b=()=>r(T=>Math.max(0,T-1)),C=()=>r(T=>Math.min(u.length-1,T+1)),x=T=>{h(),f(u[T],T+1)},m=()=>{h(),f(null,0)};return g.jsxs(g.Fragment,{children:[g.jsx("style",{children:Jg}),g.jsxs("div",{className:"inspiration-strip",children:[g.jsx("div",{className:"inspiration-label",children:"Pick a vibe →"}),g.jsxs("div",{className:"inspiration-row",children:[u.map((T,z)=>g.jsxs("div",{className:"inspiration-thumb",onClick:()=>d(z),children:[g.jsx("img",{src:T.thumb||T.url,alt:T.title||`Option ${z+1}`,loading:"lazy"}),g.jsxs("div",{className:"pick-overlay",children:[g.jsx("span",{className:"pick-icon",children:"🔍"}),g.jsx("span",{children:"View"})]})]},z)),g.jsxs("div",{className:"inspiration-skip",onClick:m,children:[g.jsx("span",{children:"Skip →"}),g.jsx("span",{children:"None fit"})]})]})]}),s!==null&&g.jsxs("div",{className:"inspo-lightbox",onClick:h,children:[g.jsx("button",{className:"inspo-lb-close",onClick:h,children:"✕"}),g.jsx("div",{onClick:T=>T.stopPropagation(),children:g.jsx("img",{className:"inspo-lb-img",src:u[s].url,alt:u[s].title||`Option ${s+1}`})}),g.jsxs("div",{className:"inspo-lb-nav",onClick:T=>T.stopPropagation(),children:[g.jsx("button",{className:"inspo-lb-arrow",onClick:b,disabled:s===0,children:"‹"}),g.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"0.5rem"},children:[g.jsxs("div",{className:"inspo-lb-actions",children:[g.jsx("button",{className:"inspo-lb-pick",onClick:()=>x(s),children:"✓ This vibe"}),g.jsx("button",{className:"inspo-lb-skip",onClick:m,children:"None fit"})]}),g.jsxs("div",{className:"inspo-lb-counter",children:[s+1," of ",u.length]}),u[s].source&&g.jsxs("div",{className:"inspo-lb-source",children:["via ",u[s].source]})]}),g.jsx("button",{className:"inspo-lb-arrow",onClick:C,disabled:s===u.length-1,children:"›"})]})]})]})}const $g=`
...
`;return u.length?g.jsxs("div",{className:"progress-bar-container",children:[g.jsx("style",{children:d}),g.jsxs("div",{className:"progress-track",children:[u.map((h,b)=>g.jsxs("div",{className:`progress-step ${b<f?"done":""} ${b===f?"active":""}`,onClick:()=>s&&s(b),role:"button",tabIndex:0,onKeyDown:C=>C.key==="Enter"&&s&&s(b),children:[g.jsx("div",{className:"step-dot"}),g.jsx("span",{className:"step-label",children:h})]},b)),g.jsx("div",{className:"progress-fill",style:{width:`${f/Math.max(u.length-1,1)*100}%`}})]})]}):null}const ny=`
  .overview-screen {
    height: 100vh;
    background: #1a1a1a;
    display: flex;
